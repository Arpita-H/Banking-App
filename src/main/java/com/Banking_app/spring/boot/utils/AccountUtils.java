...
public class AccountUtils {
    ...
    public static final String ACCOUNT_DELETION_SUCCESS_CODE = "009";
    public static final String ACCOUNT_DELETION_SUCCESS_MESSAGE = "Account has been successfully deleted!";
